...
qint64 FileEraseDialog::getFileSize(const QString &fileName, bool withRem, bool withParent, bool withSpecial, bool withBlockDev)
{
    return FileEraser::getFileSize(fileName, withRem, withParent, withSpecial, withBlockDev);
}

bool FileEraseDialog::isBlockDev(const QString &fileName)
{
    return FileEraser::isBlockDev(fileName);
}
